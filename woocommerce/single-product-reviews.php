...
?>
<div id="reviews" class="shop-single-review">
    ...
    <?php if (get_option('woocommerce_review_rating_verification_required') === 'no' || wc_customer_bought_product('', get_current_user_id(), $product->get_id())) : ?>
        <div id="review_form_wrapper" class="blog-comments-form">
            ...
            <div id="review_form">
                ...
                $comment_form['comment_field'] .= '<div class="col-md-12"><div class="form-group"><label for="comment">' . esc_html__('Your review', 'woocommerce') . '&nbsp;<span class="required">(ضروری)</span></label><textarea id="comment" name="comment" class="form-control" rows="5" placeholder="نظر خود را در مورد این محصول بنویسید."></textarea></div></div>';
