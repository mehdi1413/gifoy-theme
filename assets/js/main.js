    ...
    $('[data-countdown]').each(function () {
        ...
        $(this).countdown(finalDate, function (event) {
            $(this).html(event.strftime(
                // '<div class="row"><div class="col countdown-item"><h2>%-D</h2><h5>روز%d</h5></div><div class="col countdown-item"><h2>%H</h2><h5>ساعت</h5></div><div class="col countdown-item"><h2>%M</h2><h5>دقیقه</h5></div><div class="col countdown-item"><h2>%S</h2><h5>ثانیه</h5></div></div>'
